...
// ===========================
// Before  code any data visualizations,
...
// Set the width/height and margin of the containing box
var width = parseInt(d3.select("#scatter").style("width"));
var height = width - width / 3.9;
var margin = 20;

// Set space for placing words
var labelArea = 110;

// Set padding for the text at the bottom and left axes
var tPadBot = 40;
var tPadLeft = 40;
...
// By nesting this attribute in a function, I can easily change the location of the label group
...
// 2. Import Data.
// ========================
// The data file includes state-by-state demographic data from the US Census
// and measurements from health risks obtained
// by the Behavioral Risk Factor Surveillance System.

// Import CSV with d3's .csv import method.
...
// Call the "visualize" function on the data obtained with d3's .csv method.
function visualize(theData) {
  var curX = "poverty";
  var curY = "obesity";

  // We also save empty variables, this will allow us to alter the values in functions and remove repetitious code.
  var xMin;
  var xMax;
  var yMin;
  var yMax;
  ...
  // Create scales
  // Notice in the range method how I include the margin and word area.
  // This tells d3 to place my circles in an area starting after the margin and word area.
  var xScale = d3
    .scaleLinear()
    .domain([xMin, xMax])
  ...
  // Append the axes in group elements. By calling them, we include all of the numbers, borders and ticks.
  ...
  theCircles
    ...
    .on("mouseover", function(d) {
      // Show the tooltip
      toolTip.show(d);
      // Highlight state circle's border
